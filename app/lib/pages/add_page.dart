          ...
          child:
            ...
            FilledButton.icon(
                ...
                onPressed: () {
                  ...
                  ref.read(newItemsProvider.notifier).saveAll().then((value) {
                    if (value.isNotEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text("Some items could not be saved")));
                    }
                    setState(() {
                      editing = null;
                      savingAll = false;
            ...
            for (var i = 0; i < uploadedItems.length; i++)
              Material(
                  ...
                  child: ListTile(
                      ...
                      subtitle: Text(
                          uploadedItems[i].storageLocations?.isNotEmpty ?? false
                              ? uploadedItems[i]
                                      .storageLocations![0]
                                      .location ??
                                  ""
